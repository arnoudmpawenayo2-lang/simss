...
function StockOutForm() {
  ...
  const handleSubmit = () => {
    axios.post("http://localhost:5000/stockout", data)
  ...
  return (
    <div className="min-h-[calc(100vh-112px)] flex items-center justify-center py-10">
      <div className="w-full max-w-lg rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
        <div className="mb-6">
          <h2 className="text-2xl font-semibold text-slate-900">Stock Out</h2>
          <p className="mt-2 text-sm text-slate-500">Create a stock-out record for a spare part.</p>
        </div>
