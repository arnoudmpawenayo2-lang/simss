...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 30, 2026 at 02:07 PM
...
('root', '2026-04-30 11:56:09', '{\"Console\\/Mode\":\"collapse\"}');
...
-- Database: `sims`
--
CREATE DATABASE IF NOT EXISTS `sims` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `sims`;
...
(1, 'jeghg', 'ekhgdhkgd', -6020635, 2656235.00, 99999999.99);
...
(1, 1, 6536546, 3656352.00, 99999999.99, '2026-05-05');
...
--
ALTER TABLE `spare_part`
  MODIFY `SparePartID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
